...
def test_scope_validator_empty_config():
    config = ScopeConfig()
...
def test_scope_validator_allowed_domains():
...
def test_scope_validator_blocked_domains():
    config = ScopeConfig(
...
def test_scope_validator_port_stripping():
